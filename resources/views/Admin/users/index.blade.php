    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $user->name }}</td>
                <td>{{ $user->lastname }}</td>
                <td><img src="{{ asset('storage/perfil_image/' . $user->image) }}" alt="" style="max-width: 100px;"></td>
                <td>{{ $user->phone }}</td>
                <td>{{ $user->email }}</td>
                <td>
      ...
      <div class="modal fade" id="editModal{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form method="POST" enctype="multipart/form-data" id="profile_setup_frm" action="{{ route('user.update', $user->id) }}">
            @csrf
            ...
            <div class="col-md-8 border-right">
                <div class="p-3 py-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/perfil_image/' . $user->image) }}" style="max-width: 100px;">
                    </div>
                    <div class="mb-3">
